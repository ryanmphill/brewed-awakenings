...
const findProduct = (order, allProducts) => { // Capitalized 'P'
...
const findEmployee = (order, allEmployees) => {  // Capitalized 'E'
    let orderEmployee = null

    for (const employee of allEmployees) { // Changed 'in' to 'of'
